...
?>
<div class="dangnhap__section uk-background-norepeat uk-background-center-center uk-background-cover" data-src="images/health-still-life-with-copy-space1.png" uk-img uk-height-viewport="offset-top: true;offset-bottom: true">
                ...
                <div class="uk-child-width-1-2@m uk-grid-small uk-grid-30-m" uk-grid>
                    ...
                    <div>
                        <div class="footer__center__item16">
                            <a href="" class="xacnhandonhang__edit">Thêm địa chỉ nhà thuốc</a>
                        </div>
                        <div class="footer__center__item16">
                            <?php if ($isAddress): ?>
